...
#pragma omp target enter data map(to : A[0 : N * N], B[0 : N * N], C[0 : N * N], D[0 : N * N]) \
    map(alloc : AC[0 : N * N], BD[0 : N * N], AD[0 : N * N], BC[0 : N * N], E[0 : N * N], F[0 : N * N])
    {

#pragma omp target is_device_ptr(AC, A, C)
        {
...
#pragma omp target exit data map(from : E[0 : N * N], F[0 : N * N], AC[0 : N * N]) \
    map(delete : A[0 : N * N], B[0 : N * N], C[0 : N * N], D[0 : N * N],           \
            BD[0 : N * N], AD[0 : N * N], BC[0 : N * N])
